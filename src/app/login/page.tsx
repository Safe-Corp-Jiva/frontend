...
export default function Login() {
    ...
    <div className="bg-white grid grid-cols-2 divide-x-2 divide-teal-300 border-2 border-teal-300 flex flex-row justify-center items-center mx-auto mt-20 w-3/4 h-full rounded-md font-sans">
        ...
        <div className="w-full h-auto p-3 flex flex-col justify-center items-center flex-1">
            ...
            <form>
                <input type="text" name="username" value={username} onChange={(e) => setUsername(e.target.value)} className="block border border-gray-400 rounded-lg p-2 m-2" placeholder="Username"/>
                <input type="password" name="password" value={password} onChange={(e) => setPassword(e.target.value)} className="block border border-gray-400 rounded-lg p-2 m-2" placeholder="Password"/>
           </form> 
