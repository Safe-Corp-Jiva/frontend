...
import { createCaller } from "../graphql/mutations";
...
export default function CallerCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setSentiments(initialValues.sentiments);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createCaller.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "CallerCreateForm")}
      {...rest}
    >
      <TextField
        label="Phone"
