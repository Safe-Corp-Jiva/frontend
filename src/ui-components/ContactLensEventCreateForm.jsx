...
import { createContactLensEvent } from "../graphql/mutations";
const client = generateClient();
export default function ContactLensEventCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setRuleName(initialValues.ruleName);
    setActionName(initialValues.actionName);
    setInstanceArn(initialValues.instanceArn);
    setContactArn(initialValues.contactArn);
    setAgentArn(initialValues.agentArn);
    setQueueArn(initialValues.queueArn);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createContactLensEvent.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ContactLensEventCreateForm")}
      {...rest}
    >
      <TextField
        label="Rule name"
